...
public class Shader implements ICleanUpAble
{
    ...
    public void createShader(String path, int type)
    {
        ...
        {
            Log.trace(new Exception("Invalid shader type, must be GL20.GL_VERTEX_SHADER or GL20.GL_FRAGMENT_SHADER"));
        }

        int shaderID = GL20.glCreateShader(type);
        if(shaderID == 0)
        {
            Log.trace(new Exception("Error creating shader."));
        }
    ...
    public void createUniform(String name)
    {
        ...
        {
            Log.trace(new Exception("Could not find uniform variable with name " + name));
        }
    ...
    public void link()
    {
        ...
        {
            Log.trace(new Exception("Error linking program: " + GL20.glGetShaderInfoLog(m_programID, 1024)));
        }
        ...
        if(GL20.glGetProgrami(m_programID, GL20.GL_VALIDATE_STATUS) == 0)
        {
            ...
            {
                tmp = "No log, you can probably ignore this.";
            }
